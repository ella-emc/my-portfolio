...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed transition-transform duration-300 z-50 ${isVisible ? "translate-y-0" : "-translate-y-full"}`}>
      <div className="">
        ...
        <div className="hidden md:bg-gray-600/40 md:bg-clip-padding md:backdrop-filter md:backdrop-blur-2xl md:border md:border-gray-500 md:rounded-b-2xl md:flex md:items-center md:justify-center md:px-10 py-4  md:gap-6">
          {sections.map((section, index) => (
            <div key={index} className="text-text text-sm font-space-grotesk flex flex-row gap-x-6">
