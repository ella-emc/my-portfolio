...
const AboutSection = () => {
  return (
    <section>
      <h2 id="about" className='font-space-grotesk text-primary text-center text-lg lg:text-2xl my-12'>About</h2>

      <div className="space-y-6">
        <div className='md:grid md:grid-cols-12 md:grid-rows-5 md:gap-6 space-y-6'>
          <SpotlightCard 
            className='glassmorph rounded-2xl pt-6 col-span-5 row-span-5 flex flex-col justify-between md:mb-0 hover-zoom hover:bg-background'
          ...
          <SpotlightCard 
            className='glassmorph rounded-2xl p-6 flex items-center justify-center col-span-7 row-span-2 md:mb-0 hover-zoom hover:bg-background'
            spotlightColor1="rgba(163, 92, 240, 0.25)"
            spotlightColor2="rgba(252, 255, 111, 0.25)"
          >
          ...
          <SpotlightCard 
            className='glassmorph rounded-2xl p-6 flex items-center justify-center col-span-7 row-span-3 hover-zoom hover:bg-background'
            spotlightColor1="rgba(163, 92, 240, 0.25)"
            spotlightColor2="rgba(252, 255, 111, 0.25)"
          >
            <p className='font-space-grotesk text-base text-text-low-contrast'>
        ...
        <div className='md:grid md:grid-cols-12 gap-6 space-y-6'>
          <SpotlightCard 
            className='glassmorph col-span-7 rounded-2xl p-6 flex flex-col gap-y-6 md:mb-0 hover-zoom hover:bg-background'
            spotlightColor1="rgba(163, 92, 240, 0.25)"
            spotlightColor2="rgba(252, 255, 111, 0.25)"
          >
            <p className='font-space-grotesk text-base text-text-low-contrast'>
          ...
          <SpotlightCard 
            className='glassmorph col-span-5 rounded-2xl p-6 flex flex-col gap-y-6 hover-zoom hover:bg-background'
            spotlightColor1="rgba(163, 92, 240, 0.25)"
            spotlightColor2="rgba(252, 255, 111, 0.25)"
          >
            <p className='font-space-grotesk text-base text-text-low-contrast'>
